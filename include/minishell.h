...
int			pos_redirection(const char *big, const char *little,
...
void		ft_lstnew_addafter_pos(t_new_list **lst, t_new_list *ref,
				t_new_list *new);
...
void		all_redirect_directions_are_handled_here(int i,
				t_red_fd *red_fd, t_data *data);
void		redirect_main_execution(t_red_fd *red_fd,
				t_data *data, t_new_list *aux);

bool		is_other_file(char *str);
void		setup_signal(void);
int			heredoc(t_data *data, char *delimiter);
void		put_warning(int line, char *delimiter);
void		environment_variation_expansion_in_heredoc(char **line,
				t_data *data);
...
int			len_env_var_with_space(char **matrix, char **matrix_exp,
				t_data *data);
int			get_break_position(t_index_str *str, char *string,
				char *string_exp, t_data *data);
int			get_the_string_break_position(int index, char *string,
				char *string_exp, t_data *data);
...
char		*break_the_content_of_double_quotes(int start, int end,
